...
class FreeFromMalariaActivity(activity.Activity):
    def __init__(self, handle):
        ...
        #Adding accelerator
        self.previous_scene_button.props.accelerator = '<Primary>Left'
        ...
        ###########print "CHANGING"
        self.next_scene_button = ToolButton('next')
        self.next_scene_button.set_tooltip("Next Scene")
        # Adding accelerator
        self.next_scene_button.props.accelerator = '<Primary>Right'
        self.next_scene_id = self.next_scene_button.connect('clicked', self.next_scene_clicked)
        view_tool_bar.insert(self.next_scene_button, 2)
        self.next_scene_button.show()
        ###########
        ...
        view_tool_bar.insert(separator, 6)
        separator.show()

        stop_button = StopButton(self)
        view_tool_bar.insert(stop_button, 7)
        stop_button.show()
        ...
        #Changed so that activity can be run from both sugar-activity script as well as from default sugar.
    ...
    def set_navigation(self, switch):
        ...
        self.next_scene_button.set_sensitive(switch);
